...
// 环境变量
const UUID = process.env.UUID || '1174def5-3b33-44fa-a7b1-32d738f272d5'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nezha.ns-hqnw5rqx.svc.cluster.local:8008';       // 哪吒v1填写形式：nz.abc.com:8008   哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';           // 哪吒v1没有此变量，v0的agent端口为{443,8443,2096,2087,2083,2053}其中之一时开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || 'b9d1dcd6654ae2c9e31a18949a955411988dde12';             // v1的NZ_CLIENT_SECRET或v0的agent端口  
